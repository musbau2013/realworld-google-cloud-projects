...
sudo wget https://raw.githubusercontent.com/musbau2013/realworld-google-cloud-projects/main/apache-config/000-default.conf -P /etc/apache2/sites-enabled/
...
sudo wget https://raw.githubusercontent.com/musbau2013/realworld-google-cloud-projects/main/database-config/wp-config.php -P /var/www/wordpress/
